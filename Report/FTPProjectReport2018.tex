...
The \texttt{PWD} and \texttt{LIST} commands are intended to allow the client to know the status of the server's file system at any point in time. PWD requests that the server return the full path of the client's working directory within their 
